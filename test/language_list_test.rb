...
class LanguageListTest < Minitest::Test
  def test_all_languages
    assert_equal 7709, LanguageList::ALL_LANGUAGES.length
  end

  def test_common_languages
    assert_equal 73, LanguageList::COMMON_LANGUAGES.length
  end

  def test_living_languages
    assert_equal 6988, LanguageList::LIVING_LANGUAGES.length
  end
